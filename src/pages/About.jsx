      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          ...
          <div className="relative">
            <div className="relative rounded-2xl overflow-hidden h-56 md:h-72 lg:h-full">
              <img
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {artistInfo.achievements.map((achievement, idx) => (
              <div
                key={idx}
                className="card flex items-center space-x-4 group hover:border-orange-500"
              >
        ...
        <div className="mt-20 text-center">
          <div className="card-glass max-w-2xl mx-auto">
            ...
            <p className="text-slate-400 mb-6">
              Découvrez mes prochains spectacles et réservez vos places dès
              maintenant
            </p>
            <a
              href="/events"
