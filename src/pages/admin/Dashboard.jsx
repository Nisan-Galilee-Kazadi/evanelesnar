                                ...
                                <Link to={stat.link}>
                                    <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 hover:border-slate-700 transition-all group cursor-pointer">
                                        <div className="flex items-start justify-between mb-4">
                                            <div className={`p-3 bg-gradient-to-br ${colorClasses[stat.color]} rounded-lg`}>
                                ...
                                <div className="p-4 bg-slate-800/50 rounded-lg hover:bg-slate-800 transition-colors cursor-pointer group">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-white font-medium">Créer un événement</span>
                                        </div>
                                        <FaArrowRight className="text-slate-600 group-hover:text-slate-400 transition-colors" />
                                    </div>
                                </div>
                                ...
                                <div className="p-4 bg-slate-800/50 rounded-lg hover:bg-slate-800 transition-colors cursor-pointer group">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-white font-medium">Voir les commandes</span>
                                        </div>
                                        <FaArrowRight className="text-slate-600 group-hover:text-slate-400 transition-colors" />
                                    </div>
                                </div>
                        ...
                        {loading ? (
                            ...
                            <div className="space-y-3">
                                {recentOrders.map((order) => (
                                    <div key={order._id} className="p-4 bg-slate-800/50 rounded-lg">
                                        <div className="flex items-center justify-between mb-2">
                                            <div className="font-semibold text-white">{order.customerName}</div>
                                            <span className={`px-2 py-1 rounded text-xs font-semibold ${order.paymentStatus === 'validated'
                                        ...
                                        <div className="text-sm text-slate-400">{order.event?.title || 'Événement supprimé'}</div>
                            ...
                            <div className="text-slate-400 text-center py-8">Aucune commande</div>
                        )}
                    </div>
                </div>
            </div>
