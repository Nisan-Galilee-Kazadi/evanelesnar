...
const Events = () => {
    ...
    const filteredEvents = events.filter(event => {
        ...
        if (filter === 'available') return matchesSearch && event.status === 'upcoming';
        if (filter === 'selling-fast') return matchesSearch && event.status === 'selling-fast';
            ...
            <div className="container-custom">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-slate-400 text-lg max-w-2xl mx-auto">
                        Découvrez tous mes spectacles à venir et réservez vos billets en quelques clics
                    </p>
                </div>
                ...
                {loading ? (
                            ...
                            >
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="mb-4 space-y-2">
                                        {event.tickets.map((ticket, idx) => (
                                            <div key={idx} className="flex items-center justify-between text-sm">
                                                <span className={`font-medium flex items-center gap-1 ${ticket.type === 'VIP' ? 'text-gradient-gold' : 'text-slate-400'}`}>
                                    ...
                                    <div className="mb-4 text-sm text-slate-500">
                                        {event.tickets.reduce((sum, t) => sum + t.available, 0)} places disponibles
                                    </div>
                    ...
                    <div className="text-center py-20">
                        <div className="text-6xl mb-4 text-slate-600 flex justify-center"><FaMask /></div>
                        <h3 className="text-2xl font-bold text-white mb-2">Aucun spectacle trouvé</h3>
                ...
                <div className="mt-16 card-glass max-w-4xl mx-auto">
                    <div className="text-center">
                        ...
                        <p className="text-slate-400 mb-6">
                            Payez facilement vos billets avec M-Pesa, Orange Money, Airtel Money ou Africell Money.
                            Recevez votre billet électronique instantanément par email et WhatsApp.
                        </p>
